...
@section('content')
        ...
        <div class="bg-white border border-stone-200 rounded-lg p-5 mb-6">
            ...
            <div class="flex items-end gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="quantity" id="sell-quantity" required placeholder="0.00000000" value="{{ old('quantity') }}" class="border border-stone-300 rounded px-3 py-2 text-sm w-44 focus:outline-none focus:ring-2 focus:ring-stone-400 font-mono">
                </div>
                <div>
    ...
    <script>
        // Update total allocated as user types
